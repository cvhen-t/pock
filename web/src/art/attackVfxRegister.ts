...
import type { AttackVfxManifestEntry } from './attackVfxManifest';
import { shouldUseProceduralVfx } from './attackVfxManifest';

export function registerAttackVfxAtlas(
  scene: Phaser.Scene,
  entry: AttackVfxManifestEntry,
  buildProcedural: (scene: Phaser.Scene) => void,
): void {
...
function ensureAtlasFrames(scene: Phaser.Scene, entry: AttackVfxManifestEntry): void {
