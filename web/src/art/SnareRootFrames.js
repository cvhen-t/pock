...
import { ATTACK_VFX, SNARE_FRAME_COUNT, SNARE_FRAME_H, SNARE_FRAME_W, } from './attackVfxKeys';
/** Frame 0 crack → 1–3 spread → 4–5 wrap → 6 tighten → 7 sink. */
export function buildSnareRootAtlasProcedural(scene) {
    buildSnareAtlas(scene);
}
function buildSnareAtlas(scene) {
...
function drawSnareFrame(g, ox, oy, frame) {
