...
export interface AttackVfxManifestEntry {
  id: string;
  atlasKey: string;
  animKey: string;
  pngPath: string;
...
export const ATTACK_VFX_MANIFEST: AttackVfxManifestEntry[] = [
  {
    id: 'underground_vine',
...
export function markAttackVfxProcedural(
  scene: Phaser.Scene,
  atlasKey: string,
  procedural: boolean,
): void {
...
export function shouldUseProceduralVfx(scene: Phaser.Scene, atlasKey: string): boolean {
