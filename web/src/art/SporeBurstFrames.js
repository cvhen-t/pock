import { ATTACK_VFX, SPORE_FRAME_COUNT, SPORE_FRAME_H, SPORE_FRAME_W, } from './attackVfxKeys';
/** Frame 0 muzzle puff → 1–2 travel → 3 splash → 4–5 dissipate. */
export function buildSporeBurstAtlasProcedural(scene) {
    buildSporeAtlas(scene);
}
function buildSporeAtlas(scene) {
...
function drawSporeFrame(g, ox, oy, frame) {
