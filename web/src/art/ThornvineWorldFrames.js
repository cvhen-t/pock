import { THORNVINE_WORLD_FRAME_COUNT, THORNVINE_WORLD_FRAME_H, THORNVINE_WORLD_FRAME_W, WORLD_SPRITE, } from './worldSpriteKeys';
/** Idle swaying thornvine for placed `plant_thornvine` cards. */
export function buildThornvineWorldAtlasProcedural(scene) {
...
function drawThornvineWorldFrame(g, ox, oy, frame) {
