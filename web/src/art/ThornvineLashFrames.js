...
import { ATTACK_VFX, THORNVINE_LASH_FRAME_COUNT, THORNVINE_LASH_FRAME_H, THORNVINE_LASH_FRAME_W, } from './attackVfxKeys';
/** Thornvine lash spritesheet — visual language aligned with `ThornvineWorldFrames`. */
export function buildThornvineLashAtlasProcedural(scene) {
...
function drawThornvineLashFrame(g, ox, oy, frame) {
...
function drawLashStem(g, x0, y0, x1, y1, width, thorns) {
