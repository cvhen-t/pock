...
export type { IconDrawCtx } from './cardIconTypes';

/** 灰白圆角底，见 cardIconStyle.drawIconBackground */
export function drawIconFrame(ctx: IconDrawCtx, size: number): void {
...
function drawSurvivor(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawBush(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawBerry(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawScrapPile(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawScrap(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawScrapBundle(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawScrapPile(ctx, cx, cy - 4 * k, k * 0.85);
  ctx.strokeStyle(0x5c4a32, 2 * k, 1);
  ctx.line(cx - 12 * k, cy + 12 * k, cx + 12 * k, cy + 12 * k);
}

function drawRustShard(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
/** 避难所大本营 — 顶视铁皮棚 + 沙袋 + 指挥旗 */
function drawBaseCamp(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawWastelandShelter(ctx, cx, cy, k, { sandbags: true, flag: true, door: true, patch: true });
}

/** 流浪商人 — 条纹遮阳棚 + 货架 */
function drawTrader(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawShop(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawTrader(ctx, cx, cy, k);
  ctx.fillStyle(0x8b6914, 1);
  ctx.fillRect(cx - 10 * k, cy + 12 * k, 20 * k, 3 * k);
}

function drawSoilPlot(ctx: IconDrawCtx, cx: number, cy: number, k: number, tint: number): void {
...
function drawSoilClump(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawSeed(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawPlantThorn(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x3a3228, 1);
...
function drawPlantSpore(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawPlantSnare(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawPlantAcid(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawWeed(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawWater(ctx: IconDrawCtx, cx: number, cy: number, k: number, clean: boolean): void {
...
function drawCan(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawCaps(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x8b6914, 1);
...
function drawPlank(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x6a5a40, 1);
  ctx.fillRect(cx - 14 * k, cy - 5 * k, 28 * k, 7 * k);
  ctx.fillRect(cx - 12 * k, cy + 5 * k, 24 * k, 6 * k);
}

function drawTimber(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawFiber(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawStone(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x5a5550, 1);
...
function drawMushroomCap(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawReedStalk(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawTar(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawGlass(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawCharcoal(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawRope(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawCompost(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x3a3228, 1);
...
function drawResin(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawPlankBundle(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawPlank(ctx, cx, cy - 4 * k, k);
  ctx.strokeStyle(0x5c4a32, 2 * k, 1);
  ctx.line(cx - 14 * k, cy + 10 * k, cx + 14 * k, cy + 10 * k);
}

function drawSalt(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawHide(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x6a5a48, 1);
...
function drawBrick(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawNailBox(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x5c4a38, 1);
...
function drawIngot(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x6a6560, 1);
...
function drawWireSpool(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x5c4a38, 1);
...
function drawIronPlate(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x5a5550, 1);
...
function drawCanvas(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawFertilizer(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawFeedBag(ctx, cx, cy, k);
  ctx.fillStyle(0x4a5a32, 0.8);
  ctx.fillCircle(cx + 8 * k, cy - 8 * k, 4 * k);
}

function drawAcidVial(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawFuel(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x5c4a38, 1);
...
function drawBlueprint(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawFlour(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x8a8478, 1);
  ctx.fillRoundedRect(cx - 10 * k, cy - 6 * k, 20 * k, 14 * k, 2 * k);
...
function drawBread(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x8b7355, 1);
...
function drawEgg(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawCheese(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawMeat(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawSoup(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x5c4a38, 1);
  ctx.fillEllipse(cx, cy + 4 * k, 16 * k, 10 * k);
...
function drawFeedBag(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x5a4a32, 1);
...
function drawBone(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0xc9c4b8, 1);
...
function drawPellet(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x5a4a38, 1);
  for (let i = -1; i <= 1; i++) {
...
function drawCropWheat(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawCropSun(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x8b7355, 1);
...
function drawCropCactus(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x4a5a38, 1);
...
function drawChick(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0xc9a86a, 1);
  ctx.fillCircle(cx, cy + 2 * k, 8 * k);
  ctx.fillCircle(cx + 6 * k, cy - 4 * k, 5 * k);
}

function drawHen(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawChick(ctx, cx, cy, k * 1.15);
  ctx.fillStyle(0x8b5038, 1);
  ctx.fillTriangle(cx + 10 * k, cy - 6 * k, cx + 16 * k, cy - 4 * k, cx + 10 * k, cy);
}

function drawGoat(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x8a8478, 1);
  ctx.fillEllipse(cx, cy + 4 * k, 18 * k, 10 * k);
  ctx.fillCircle(cx + 10 * k, cy - 6 * k, 6 * k);
}

function drawMilk(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawWater(ctx, cx, cy, k, true);
  ctx.fillStyle(0xc9c4b8, 0.5);
  ctx.fillEllipse(cx, cy - 2 * k, 6 * k, 4 * k);
}

function drawRabbit(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x8a8478, 1);
  ctx.fillEllipse(cx, cy + 4 * k, 14 * k, 10 * k);
...
function drawPig(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x7a5a58, 1);
  ctx.fillEllipse(cx, cy + 2 * k, 20 * k, 12 * k);
  ctx.fillCircle(cx + 10 * k, cy - 4 * k, 6 * k);
}

function drawBeetle(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x4a4038, 1);
  ctx.fillEllipse(cx, cy, 16 * k, 10 * k);
...
function drawLard(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawCan(ctx, cx, cy, k);
  ctx.fillStyle(0xc9c4b8, 0.6);
  ctx.fillRect(cx - 4 * k, cy - 2 * k, 8 * k, 4 * k);
}

function drawFeather(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x8a8478, 0.9);
...
function drawHound(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawWatchDog(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawHound(ctx, cx, cy, k * 0.9);
  ctx.strokeStyle(0x6a5f52, 2 * k, 0.9);
  ctx.line(cx - 14 * k, cy + 10 * k, cx + 14 * k, cy + 10 * k);
}

function drawPup(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawHound(ctx, cx, cy, k * 0.75);
}

function drawFence(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawWall(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawWireTrap(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.strokeStyle(0x7a7068, 2 * k, 1);
  for (let i = 0; i < 4; i++) {
...
function drawCoop(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawPenGoat(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawFence(ctx, cx, cy, k * 0.85);
  drawGoat(ctx, cx, cy + 4 * k, k * 0.55);
}

function drawPenRabbit(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawFence(ctx, cx, cy, k * 0.85);
  drawRabbit(ctx, cx, cy + 6 * k, k * 0.55);
}

function drawPenPig(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawFence(ctx, cx, cy, k * 0.85);
  drawPig(ctx, cx, cy + 6 * k, k * 0.5);
}

function drawKennel(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawCoop(ctx, cx, cy, k);
  ctx.fillStyle(0x5a4040, 0.9);
  ctx.fillCircle(cx, cy + 6 * k, 5 * k);
}

function drawInsectCrate(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x5c4a38, 1);
  ctx.fillRoundedRect(cx - 14 * k, cy - 6 * k, 28 * k, 16 * k, 2 * k);
  drawBeetle(ctx, cx, cy - 2 * k, k * 0.6);
}

function drawMushroomBed(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawSoilPlot(ctx, cx, cy + 4 * k, k, 0x3a4a32);
  drawMushroomCap(ctx, cx - 8 * k, cy - 8 * k, k * 0.7);
  drawMushroomCap(ctx, cx + 8 * k, cy - 6 * k, k * 0.65);
}

function drawReedPatch(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawSoilPlot(ctx, cx, cy + 6 * k, k, 0x3a4a32);
  drawReedStalk(ctx, cx, cy - 4 * k, k);
}

function drawBlade(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x7a7068, 1);
...
function drawBow(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.strokeStyle(0x6a6058, 2.5 * k, 1);
  ctx.strokeEllipse(cx, cy, 15 * k, 20 * k);
  ctx.line(cx - 11 * k, cy, cx + 11 * k, cy);
}

function drawMolotov(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawWildSoil(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawSoilPlot(ctx, cx, cy, k, 0x5a4a38);
  ctx.fillStyle(0x4a6a38, 0.55);
  ctx.fillCircle(cx - 11 * k, cy - 5 * k, 5 * k);
}

function drawWildOre(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x4a4848, 1);
...
function drawWildTree(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x4a4030, 1);
...
function drawWildLake(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
...
function drawWildBeach(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x6a5a48, 1);
...
function drawWildMarsh(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  drawWildLake(ctx, cx, cy, k);
...
function drawGeneric(ctx: IconDrawCtx, cx: number, cy: number, k: number): void {
  ctx.fillStyle(0x6a5a48, 1);
