...
import { MAIN_MENU_COLORS, MAIN_MENU_COPY, MAIN_MENU_LAYOUT, } from '../config/mainMenuConfig';
...
export default class MainMenuPanel extends Phaser.GameObjects.Container {
    ...
    continueHint;
    versionText;
    panelW = MAIN_MENU_LAYOUT.panelMaxW;
    panelH = 320;
    constructor(scene, callbacks) {
        ...
        this.startBtn = new MenuButton(scene, 0, 0, MAIN_MENU_COPY.startLabel, MAIN_MENU_LAYOUT.btnW, MAIN_MENU_LAYOUT.btnH, callbacks.onStart, {
        ...
        this.continueBtn = new MenuButton(scene, 0, 0, MAIN_MENU_COPY.continueLabel, MAIN_MENU_LAYOUT.btnW, MAIN_MENU_LAYOUT.btnH, callbacks.onContinue, {
    ...
    setContinueEnabled(enabled, summary) {
